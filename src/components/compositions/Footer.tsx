...
// TODO: Change the wrapper from section to footer and choose a different container tag.
export function Footer({}: FooterProps) {
  return (
    <section className="flex border-t border-gray-100">
      <footer className="w-full flex flex-col bg-gray-50">
        ...
        <div className="w-full bg-gray-800 py-4">
          <div className="wrapper flex items-center justify-center md:justify-start gap-4">
