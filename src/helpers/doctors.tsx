...
export const doctors: IDoctor[] = [
  ...
  },
  {
    ...
    description: "Olá! Sou o Dr. Marcelo Lima, médico, com anos de experiência em diversas áreas da medicina. Meu foco é ajudar meus pacientes a alcançarem uma vida saudável e equilibrada. Como especialista em emagrecimento e longevidade, busquei aprimorar meus conhecimentos nas áreas de bem-estar e medicina integrativa, esportiva, modulação hormonal e hipertrofia. Estou sempre me atualizando com as práticas mais modernas da medicina para oferecer os melhores cuidados aos meus pacientes. Além do meu trabalho clínico, compartilho regularmente dicas e orientações valiosas em minhas redes sociais, fique por dentro.",
    image: "/images/doctors/doctor-marcelo-alt.jpeg",
    social: [
      {
